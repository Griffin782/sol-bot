// SOL-BOT V2 Advanced Monitor
// Created: November 11, 2025
// Purpose: Provide enhanced token buy/sell tracking and quality metrics
...
async function processLogFile(filePath, lastPosition = 0) {
  ...
  return new Promise((resolve, reject) => {
    ...
    rl.on('line', (line) => {
      ...
      else if (PATTERNS.metadataError.test(line)) {
...
function displayHeader(runtime) {
  ...
  console.log(`${colors.bg.blue}${colors.fg.white}${colors.bright} SOL-BOT MONITOR V2 ${colors.reset}`);
  console.log(`${colors.fg.cyan}Runtime: ${timeStr} | Last Update: ${new Date().toLocaleTimeString()}${colors.reset}\n`);
}
